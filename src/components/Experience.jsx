    ...
    >
      ...
      <span
        style={{
          ...
          borderRadius: "50%",
          background: accent,
          boxShadow: `0 0 0 4px ${isDark ? "rgba(155,92,255,0.18)" : "rgba(0,122,255,0.18)"}`,
        }}
      />
...
function CertCard({ cert, isDark, onPreview }) {
  const accent = isDark ? "#9B5CFF" : "#007AFF";
  const accentGlow = isDark ? "rgba(155,92,255,0.30)" : "rgba(0,122,255,0.25)";
...
const expItems = [
  {
    ...
    company: "CodeAlpha",
    desc: "Completed a virtual machine learning internship, working on practical ML tasks and applying machine learning concepts to real-world datasets.",
  },
  {
    date: "May 2025",
    role: "Data Analytics Virtual Intern",
    company: "Deloitte — via Forage",
    desc: "Cleaned, analyzed and visualized client data in Tableau to identify key business insights and support data-driven recommendations.",
  },
  {
    date: "2024 – Present",
    role: "Social Media Head",
    company: "Think India MANIT",
    desc: "Led a 60+ member content and outreach team, managed social media strategy, and contributed to campaigns generating 2M+ cumulative views.",
  },
  {
    date: "2024 – Present",
    role: "Graphic Designer",
    company: "Drishtant",
    desc: "Created visual designs, promotional creatives and digital content for college events, publications and organizational campaigns.",
  },
];
...
const eduItems = [
  {
    ...
    desc: "Undergraduate studies in Computer Science and Engineering, with a focus on software development, data structures, algorithms, machine learning and web technologies.",
    logo: manit,
  },
  {
    date: "2021 – 2023",
  ...
  },
  {
    ...
    company: "Jai Gurudev International School",
    desc: "Completed secondary education with active participation in academic and extracurricular activities.",
    logo: jgis,
  },
];
...
const certs = [
  ...
  {
    title: "Arduino Hands-on Training",
    issuer: "VISION ECE & EE",
    date: "18 Feb 2024",
    image: cert3,
  },
  {
          ...
          >
            ...
            >
              ...
              <div
                style={{
                  position: "relative",
                  borderLeft: `1.5px solid ${borderC}`,
                }}
              >
                {expItems.map((item, i) => (
            ...
            >
              <motion.div variants={fadeUp} style={{ marginBottom: "2rem" }}>
                ...
                >
                  <span style={{ color: accent }}>Education</span>al Background
                </h2>
              </motion.div>
              <div
                style={{
